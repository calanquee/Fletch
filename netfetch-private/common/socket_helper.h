...
#define SWITCHOS_POPCLIENT_FOR_REFLECTOR_TIMEOUT_USECS 500000 // 0.1s
#define SWITCHOS_SNAPSHOTCLIENT_FOR_REFLECTOR_TIMEOUT_USECS 500000 // 0.1s
#define SWITCHOS_SPECIALCASESERVER_TIMEOUT_USECS 1000 // 1ms
#define CONTROLLER_SNAPSHOTCLIENT_FOR_SPINESWITCHOS_TIMEOUT_USECS 500000 // 0.1s
#define CONTROLLER_SNAPSHOTCLIENT_FOR_LEAFSWITCHOS_TIMEOUT_USECS 500000 // 0.1s
