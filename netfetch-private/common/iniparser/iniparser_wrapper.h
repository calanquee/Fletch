...
class IniparserWrapper {
   public:
    ...
    int get_file_metadata_length();
    int get_dir_metadata_length();
    int get_path_resolution_offset();
    ...
    short get_client_port1_for_handling_updatecache();
    short get_client_port2_for_handling_updatecache();
    ...
    uint16_t get_file_parser_offset();
    int get_server_thread_pool_size();
    int get_delete_server_number();
    ...
    const char* get_server_ip_for_invalidation_list(uint32_t server_physical_idx);
    const char* get_server_port_for_invalidation_list(uint32_t server_physical_idx);
    const char* get_another_server_ip_for_invalidation_list(uint32_t server_physical_idx);
    ...
    const char* get_root_path_for_fs_tree(uint32_t switchos_idx = 0x3f3f3f3f);
    ...
    short get_switchos_server_eviction_port(uint32_t switchos_idx = 0x3f3f3f3f);
    // Qingxiu: add a new interface to obtain switchos_evict_threshold
    uint16_t get_switchos_evict_threshold(uint32_t switchos_idx = 0x3f3f3f3f);
    uint32_t get_cache_lookup_table_size(uint32_t switchos_idx = 0x3f3f3f3f);
    ...
    // Qingxiu: add an interface to obtain the port for loading freq.
    short get_reflector_cp2dpserver_loadfreq_port(uint32_t reflector_idx = 0x3f3f3f3f);
    ...
    short get_server_valuedeleteserver_port_start(); // netfetch rm/rmdir/
