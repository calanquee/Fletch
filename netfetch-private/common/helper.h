...
#define NETFETCH_ID 7

typedef int method_t;

static const char *methodname_list[] = {"invalid", "farreach", "nocache", "netcache", "distfarreach", "distnocache", "distcache", "netfetch"};

static const char *get_methodname_byid(method_t methodid) {
	if (methodid == INVALID_ID || methodid > NETFETCH_ID) {
...
#define MQ_SIZE 655350 // in-memory message queue
