...
// Qingxiu: remove magic number in p4 code
// Qingxiu: if update in-switch header length, plz update this value
#define INSWITCH_HEADER_OFFSET 35


// NOTE: 1B optype does not need endian conversion
// 0b0001
#define PUTREQ 0x0001 // chmod
#define PUTREQ_TOUCH_MKDIR 0x0011 // touch/mkdir/ls
#define PUTREQ_RM_RMDIR 0x0021 // mv/rm/rmdir
...
#define PRE_GETRES 0x0019
#define GETRES_NO_UNLOCK 0x0029
#define GETRES_UNLOCK 0x0039
#define GETRES_FINAL 0x0049
#define GETRES_ACK 0x0059
#define GETRES_PKT_LOSS_ACK 0x0069
// 0b0101
...
#define CACHE_EVICT_LOADFREQ_INSWITCH_PERIOD 0x0084
#define VALID_INSWITCH 0x0094
// For large value
...
#define GETREQ_RECIR 0x0010 // Qingxiu: change SCANREQ to GETREQ_RECIR
...
#define CACHE_EVICT_LOADFREQ_INSWITCH_PERIOD_ACK 0x1100
...
#define LOOKUP_ENTRY_COUNT 16384
...
#define LOCK_BUCKET_COUNT 65536
