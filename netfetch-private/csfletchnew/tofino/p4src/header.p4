...
header seq_t {
	...
	bit<16> sequence_number_from_server;
}
...
struct ingress_metadata {
	...
	bit<1> is_counter_equal_to_sequence; // sequence is from server
	...
	bit<16> is_counter;
	// bit<8> is_counter_equal_to_sequence;
}
